...
//           arr.find((x) => x.id === data.data.messId).contractor =
//             data.data.name;
...
//               <Nav.Item key={x.id}>
//                 <Nav.Link
//                   href={"/messpage/" + lod.lowerCase(x.name)}
//                   state={{ from: x.info, id: x.id }}
//                 >
//                   {x.name}
//                 </Nav.Link>
//               </Nav.Item>
...
//                     </center>
//                     <h6>contractor: {x.contractor}</h6>
//                     <h6>Mobile: {x.phno}</h6>
//                     <Link
//                       to={"/messpage/" + lod.lowerCase(x.name)}
//                       state={{ from: x.info, id: x.id }}
//                     >
//                       <img
//                         className="img-fluid"
...
export default function ExploreMess() {
  return (
    <Base title="Mess">
      <div>
        <ExplorePage option={1} />
      </div>
    </Base>
  );
}
