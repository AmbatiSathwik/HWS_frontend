...
function Modal2(props) {
    ...
    return (
      <>
        <p style={{display:"inline-block", fontSize:"16px"}} onClick={handleShow}>
          {props.content.title}
        </p>
...
function Warden() {
                ...
                <div style={{height:"200px" ,overflowX:"hidden" ,overflowY:"auto"}}>
                    {data.map((x)=>{
                        return (
                            <Row style={{textAlign:"center"}}>
                                <Col  xs="3" className="d-none d-md-block">
                                    <p style={{display:"inline-block", fontSize:"16px"}}>{x.date}</p>
                                </Col>
                                <Col xs="3" className="d-none d-md-block">
                                    <p style={{display:"inline-block", fontSize:"16px"}}>{x.name}</p>
                                </Col>
                                <Col xs="3" className='d-md-none'></Col>
    ...
    return (
        <Base title="Warden">
            ...
            <div className="card" >
                ...
                <Row>
                    <Col  xs="4" sm="3" className="column">
                        <p style={{display:"inline-block", fontSize:"20px"}}>Name/ID:</p>
                    </Col>
                    <Col xs="8" sm="6">
            ...
            <div className="card" >
                <h2 align="center" className="mb-4">Roommates Details</h2>
                <Row>
                    <Col  xs="4" sm="3" className="column">
                        <p style={{display:"inline-block", fontSize:"20px"}}>Room No:</p>
                    </Col>
                    <Col xs="8" sm="6">
                        <MDBInput value={room}  id='typeText' style={{backgroundColor:"white"}} type='text' onChange={(x)=>{setRoom(x.target.value)}} />
                    </Col>
                </Row>
                <Row>
                    <Col align={'right'}>
            ...
            <div className="card" >
                <h2 align="center" className="mb-4">Hostel Count</h2>
                <Row align="center">
                    <Col xs='4'>
                    <h3 style={{display:"inline-block", fontSize:"20px"}}>Hostel</h3>
                    </Col>
                    <Col  xs="4">
                        <h3 style={{display:"inline-block", fontSize:"20px"}}>Capacity</h3>
                    </Col>
                    <Col xs="4">
                        <h3 style={{display:"inline-block", fontSize:"20px"}}>Vacancy</h3>
                    </Col>
                </Row>
                <Row align="center">
                    <Col xs='4'>
                        <p style={{display:"inline-block", fontSize:"20px"}}>A Hostel</p>
                    </Col>
                    <Col  xs="4">
        ...
        <Complaint></Complaint>
            <Row align='center'>
                ...
                <Col xs="3">
                    <FormControl fullWidth >
                        <Select
                            ...
                            displayEmpty
                            value={floor}
                            onChange={(x)=>{setFloor(x.target.value)}}
                        >
                ...
                <Col xs='3' align={'right'}><Button variant='dark' style={{width:"75px"}}>Filter</Button></Col>
            </Row>
        </div>
            <div className="card">
                <div>
                    <center>
                        <h3>Caretaker/Attendees Details</h3></center>
                    <div>
                        <MDBTable scrollY>
